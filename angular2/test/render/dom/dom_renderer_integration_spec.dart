...
main() {
  describe("DomRenderer integration", () {
    ...
    it("should attach and detach component views", inject([
      AsyncTestCompleter,
      DomTestbed
    ], (async, tb) {
      tb
    ...
    it("should update element properties", inject([
      AsyncTestCompleter,
      DomTestbed
    ], (async, tb) {
      tb
    ...
    it("should call actions on the element", inject([
      AsyncTestCompleter,
      DomTestbed
    ], (async, tb) {
      tb
    ...
    it("should add and remove views to and from containers", inject([
      ...
      tb
        ...
        expect(tb.rootEl).toHaveText("");
        var childView =
            tb.createViewInContainer(cmpView.viewRef, 0, 0, childProto);
        expect(tb.rootEl).toHaveText("hello");
