...
import "package:angular2/src/change_detection/proto_record.dart"
    show RECORD_TYPE_SELF, ProtoRecord;

main() {
  r(funcOrValue, args, contextIndex, selfIndex, [lastInBinding = false]) {
    return new ProtoRecord(99, "name", funcOrValue, args, null, contextIndex,
        null, selfIndex, null, null, lastInBinding, false);
  }
  describe("change detection - coalesce", () {
    ...
    it("should replace duplicate terminal records with" + " self records", () {
      ...
      expect(rs[1]).toEqual(new ProtoRecord(RECORD_TYPE_SELF, "self", null, [],
          null, 1, null, 2, null, null, true, false));
    });
  });
}
