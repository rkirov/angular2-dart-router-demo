library examples.src.material.switcher.index;

import "package:angular2/angular2.dart" show bootstrap;
import "package:angular2_material/src/components/switcher/switch.dart"
    show MdSwitch;
...
@View(templateUrl: "./demo_app.html", directives: const [MdSwitch])
class DemoApp {
  num toggleCount;
  DemoApp() {
    this.toggleCount = 0;
