library benchpress.test.reporter.console_reporter_spec;

import "package:angular2/test_lib.dart"
    show describe, ddescribe, it, iit, xit, expect, beforeEach, afterEach;
import "package:angular2/src/facade/lang.dart"
    show isBlank, isPresent, DateTime, DateWrapper;
...
main() {
  describe("console reporter", () {
    var reporter;
    var log;
    createReporter({columnWidth, sampleId, descriptions, metrics}) {
      log = [];
      ...
      var bindings = [
        ...
        bind(ConsoleReporter.PRINT)
            .toValue((line) => ListWrapper.push(log, line))
      ];
      if (isPresent(columnWidth)) {
        ListWrapper.push(
            bindings, bind(ConsoleReporter.COLUMN_WIDTH).toValue(columnWidth));
      }
