library benchpress.test.statistic_spec;

import "package:angular2/test_lib.dart"
    show describe, ddescribe, it, iit, xit, expect, beforeEach, afterEach;
import "package:benchpress/src/statistic.dart" show Statistic;
import "package:angular2/src/facade/math.dart" show NaN;
...
main() {
  describe("statistic", () {
    ...
    it("should calculate the standard deviation", () {
      ...
      expect(Statistic.calculateStandardDeviation([2, 4, 4, 4, 5, 5, 7, 9], 5))
          .toBe(2.0);
    });
    it("should calculate the coefficient of variation", () {
      ...
      expect(Statistic.calculateCoefficientOfVariation(
          [2, 4, 4, 4, 5, 5, 7, 9], 5)).toBe(40.0);
    });
    it("should calculate the regression slope", () {
      ...
      expect(Statistic.calculateRegressionSlope([1, 2], 1.5, [2, 4], 3))
          .toBe(2.0);
    });
  });
}
