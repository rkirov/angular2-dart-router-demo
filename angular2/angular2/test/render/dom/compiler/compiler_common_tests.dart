  ...
  describe("compiler", () {
    ...
    it("should run the steps and build the proto view", inject(
      ...
      compiler.compileHost(dirMetadata).then((protoView) {
        expect(DOM.tagName(protoView.render.delegate.element))
            .toEqual("CUSTOM");
    ...
    it("should use the inline template and compile in sync", inject(
      ...
      compiler
          ...
          .then((protoView) {
        expect(DOM.getInnerHTML(protoView.render.delegate.element))
    ...
    it("should load url templates", inject([AsyncTestCompleter], (async) {
      ...
      compiler
          .compile(new ViewDefinition(componentId: "someId", absUrl: "someUrl"))
          .then((protoView) {
        expect(DOM.getInnerHTML(protoView.render.delegate.element))
    ...
    it("should wait for async subtasks to be resolved", inject(
      ...
      expect(subTasksCompleted).toEqual(
          false); // The Promise should resolve after the subtask is ready
