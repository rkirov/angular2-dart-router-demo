...
main() {
  describe("PropertyBindingParser", () {
    ...
    process(element, [hasNestedProtoView = false]) {
    ...
    it("should store property setters as camel case", () {
      ...
      expect(MapWrapper.get(results[0].propertyBindings, "someProp"))
          .toBeTruthy();
    });
    ...
    it("should store variable binding for a template element on the nestedProtoView",
      ...
      expect(MapWrapper.get(
              results[0].nestedProtoView.variableBindings, "washington"))
          .toEqual("george");
    });
    ...
    it("should store variable binding for a non-template element", () {
      ...
      expect(MapWrapper.get(results[0].variableBindings, "washington"))
          .toEqual("george");
    });
    ...
    it("should store a variable binding with an implicit value", () {
      ...
      expect(MapWrapper.get(results[0].variableBindings, "\$implicit"))
          .toEqual("george");
    });
    ...
    it("should detect () syntax", () {
      ...
      expect(eventBinding.fullName).toEqual(
          "click"); // "(click[])" is not an expected syntax and is only used to validate the regexp
