library angular2.test.change_detection.pipes.async_pipe_spec;
...
import "package:angular2/src/change_detection/pipes/pipe.dart"
    show WrappedValue;
import "package:angular2/src/change_detection/pipes/async_pipe.dart"
    show AsyncPipe;
  ...
  describe("AsyncPipe", () {
    ...
    describe("transform", () {
      ...
      it("should dispose of the existing subscription when subscribing to a new observable",
        ...
        expect(pipe.transform(newEmitter))
            .toBe(null); // this should not affect the pipe
        ObservableWrapper.callNext(emitter, message);
        PromiseWrapper.setTimeout(() {
