...
@View(renderer: "imp-ng-cmp-renderer")
class ImperativeViewComponentUsingNgComponent {
  var done;
  ImperativeViewComponentUsingNgComponent(ElementRef self,
      DynamicComponentLoader dynamicComponentLoader,
      DirectDomRenderer renderer) {
    var div = el("<div></div>");
    renderer.setImperativeComponentRootNodes(
        self.parentView.render, self.boundElementIndex, [div]);
    this.done =
        dynamicComponentLoader.loadIntoNewLocation(ChildComp, self, div, null);
  }
}
