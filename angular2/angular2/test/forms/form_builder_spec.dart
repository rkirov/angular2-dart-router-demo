library angular2.test.forms.form_builder_spec;

import "package:angular2/test_lib.dart"
    show ddescribe, describe, it, iit, xit, expect, beforeEach, afterEach, el;
import "package:angular2/forms.dart" show Control, FormBuilder, Validators;
...
main() {
  describe("Form Builder", () {
    ...
    it("should create groups with a custom validator", () {
      var g = b.group(
          {"login": "some value"}, {"validator": Validators.nullValidator});
    ...
    it("should create control arrays", () {
      ...
      var a =
          b.array(["one", ["two", Validators.required], c, b.array(["four"])]);
