library angular2.src.render.dom.shadow_dom.shadow_css;
...
class ShadowCss {
  ...
  */
  String shimStyle(style, String selector, [String hostSelector = ""]) {
  ...
  */
  ...
  String _applySelectorScope(
    ...
    return this._applySimpleSelectorScope(
        selector, scopeSelector, hostSelector);
  ...
  String _applyStrictSelectorScope(String selector, String scopeSelector) {
    ...
    for (var i = 0; i < splits.length; i++) {
      ...
      scoped = ListWrapper.map(parts, (p) {
  ...
  String _propertiesFromRule(rule) {
    var cssText =
        rule.style.cssText; // TODO(sorvell): Safari cssom incorrectly removes quotes from the content
...
var _cssContentUnscopedRuleRe = RegExpWrapper.create(
    ...
    "im");
var _polyfillHost =
    "-shadowcsshost"; // note: :host-context pre-processed to -shadowcsshostcontext.
...
var _shadowDOMSelectorsRe = [
  ...
  RegExpWrapper.create("::content"), // Deprecated selectors
