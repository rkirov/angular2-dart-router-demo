...
class EventManager {
  ...
  VmTurnZone _zone;
  EventManager(List<EventManagerPlugin> plugins, VmTurnZone zone) {
    this._zone = zone;
...
class EventManagerPlugin {
  EventManager manager; // We are assuming here that all plugins support bubbled and non-bubbled events.
...
class DomEventsPlugin extends EventManagerPlugin {
  EventManager manager; // This plugin should come last in the list of plugins, because it accepts all
  // events.
  bool supports(String eventName) {
    return true;
  }
  ...
  _getOutsideHandler(
      bool shouldSupportBubble, element, Function handler, VmTurnZone zone) {
