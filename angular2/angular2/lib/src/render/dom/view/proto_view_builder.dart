...
import "element_binder.dart" show ElementBinder, Event;
import "property_setter_factory.dart" show setterFactory;
import "../../api.dart" as api;
import "../direct_dom_renderer.dart" as directDomRenderer;
...
class ProtoViewBuilder {
  ...
  ProtoViewBuilder setImperativeRendererId(String id) {
    ...
    ListWrapper.forEach(this.elements, (ebb) {
      ...
      ListWrapper.push(renderElementBinders, new ElementBinder(
          ...
          nestedProtoView: isPresent(nestedProtoView)
              ? nestedProtoView.render.delegate
              : null,
...
class ElementBinderBuilder {
  ...
  bindProperty(name, expression) {
    MapWrapper.set(this.propertyBindings, name,
        expression); //TODO: required for Dart transformers. Remove when Dart transformers
