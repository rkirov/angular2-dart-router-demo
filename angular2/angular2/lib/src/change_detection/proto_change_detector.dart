...
class DynamicProtoChangeDetector extends ProtoChangeDetector {
  ...
  List<String> _variableBindings;
  List<DirectiveRecord> _directiveRecords;
  String _changeControlStrategy;
  DynamicProtoChangeDetector(PipeRegistry pipeRegistry, List bindingRecords,
      List variableBindings, List directiveRecords,
...
class JitProtoChangeDetector extends ProtoChangeDetector {
  ...
  List<DirectiveRecord> _directiveRecords;
  String _changeControlStrategy;
  JitProtoChangeDetector(pipeRegistry, List bindingRecords,
      List variableBindings, List directiveRecords,
      String changeControlStrategy)
      : super() {
    /* super call moved to initializer */;
...
class ProtoRecordBuilder {
  ...
  addAst(BindingRecord b, [List variableBindings = null]) {
...
class _ConvertAstIntoProtoRecords {
  ...
  List variableBindings;
  num contextIndex;
  String expressionAsString;
  _ConvertAstIntoProtoRecords(BindingRecord bindingRecord, num contextIndex,
      String expressionAsString, List variableBindings) {
    this.protoRecords = [];
  ...
  static convert(BindingRecord b, num contextIndex, List variableBindings) {
