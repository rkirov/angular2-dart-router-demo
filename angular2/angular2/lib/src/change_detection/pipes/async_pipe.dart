library angular2.src.change_detection.pipes.async_pipe;

import "package:angular2/src/facade/async.dart" show Stream, ObservableWrapper;
import "package:angular2/src/facade/lang.dart" show isBlank, isPresent, CONST;
...
class AsyncPipe extends Pipe {
  ...
  Stream _observable;
  AsyncPipe(ChangeDetectorRef ref) : super() {
 ...
 * @exportedAs angular2/pipes
 */
class AsyncPipeFactory extends PipeFactory {
  @CONST() const AsyncPipeFactory() : super();
  bool supports(obs) {
    return ObservableWrapper.isObservable(obs);
  }
  Pipe create(cdRef) {
