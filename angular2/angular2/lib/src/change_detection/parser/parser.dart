...
var _implicitReceiver =
    new ImplicitReceiver(); // TODO(tbosch): Cannot make this const/final right now because of the transpiler...
...
class Parser {
  ...
  ASTWithSource addPipes(ASTWithSource bindingAst, List<String> pipes) {
    ...
    var res = ListWrapper.reduce(pipes, (result, currentPipeName) =>
...
class _ParseAST {
  ...
  bool parseAction;
  int index;
  _ParseAST(String input, dynamic location, List tokens, Reflector reflector,
      bool parseAction) {
    this.input = input;
