...
import "package:angular2/src/facade/lang.dart"
    show CONST, normalizeBlank, isPresent;
...
import "package:angular2/change_detection.dart"
    show DEFAULT; // type StringMap = {[idx: string]: string};
...
class Directive extends Injectable {
  ...
  @CONST() const Directive({selector, properties, events, hostListeners,
      hostProperties, lifecycle, compileChildren: true})
      : selector = selector,
...
class Component extends Directive {
  ...
  @CONST() const Component({selector, properties, events, hostListeners,
      hostProperties, injectables, lifecycle, changeDetection: DEFAULT,
