...
import "package:angular2/src/facade/lang.dart"
    show isPresent, isBlank, Type, int, BaseException;
...
class ProtoElementInjector {
  ...
  num numberOfDirectives; /** Whether the element is exported as $implicit. */
  bool exportElement; /** Whether the component instance is exported as $implicit. */
  bool exportComponent; /** The variable name that will be set to $implicit for the element. */
...
class ElementInjector extends TreeNode {
  ...
  ElementInjector _host; // If this element injector has a component, the component instance will be stored in _obj0
  dynamic _obj0;
  dynamic _obj1;
  dynamic _obj2;
  dynamic _obj3;
  ...
  DirectiveBinding _dynamicallyCreatedComponentBinding; // Queries are added during construction or linking with a new parent.
  ...
  ElementInjector(ProtoElementInjector proto, ElementInjector parent)
    ...
    /* super call moved to initializer */;
    this._proto =
        proto; //we cannot call clearDirectives because fields won't be detected
  ...
  instantiateDirectives(Injector lightDomAppInjector, ElementInjector host,
      Injector shadowDomAppInjector, PreBuiltObjects preBuiltObjects) {
    this._host = host;
  ...
  _getPreBuiltObjectByKeyId(int keyId) {
    ...
    if (identical(keyId,
        staticKeys.viewManagerId)) return this._preBuiltObjects.viewManagerId; //TODO add other objects as needed
    return _undefined;
  }
...
class QueryError extends Error {
  String message; // TODO(rado): pass the names of the active directives.
  QueryError() : super() {
    /* super call moved to initializer */;
