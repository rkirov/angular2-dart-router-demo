...
class DynamicComponentLoader {
   ...
   */
  Future<ComponentRef> loadIntoNewLocation(typeOrBinding,
      ElementRef parentComponentLocation, dynamic elementOrSelector,
    ...
    return this._compiler
      ...
      var hostViewRef = this._viewManager.createInPlaceHostView(
          parentComponentLocation, elementOrSelector, hostProtoViewRef,
          injector);
  ...
  Future<ComponentRef> loadNextToExistingLocation(
    ...
    return this._compiler.compileInHost(binding).then((hostProtoViewRef) {
      ...
      var hostViewRef = viewContainer.create(
          hostProtoViewRef, viewContainer.length, injector);
      var newLocation = new ElementRef(hostViewRef, 0);
      var component = this._viewManager.getComponent(newLocation);
      var dispose = () {
