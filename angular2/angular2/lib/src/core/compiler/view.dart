...
import "package:angular2/src/facade/lang.dart"
    show IMPLEMENTS, int, isPresent, isBlank, BaseException;
...
class AppView implements ChangeDispatcher {
  renderApi.RenderViewRef render; /// This list matches the _nodes list. It is sparse, since only Elements have ElementInjector
  List<ElementInjector> rootElementInjectors;
  List<ElementInjector> elementInjectors;
  ChangeDetector changeDetector;
  List<AppView> componentChildViews; /// Host views that were added by an imperative view.
  /// This is a dynamically growing / shrinking array.
  List<AppView> imperativeHostViews;
