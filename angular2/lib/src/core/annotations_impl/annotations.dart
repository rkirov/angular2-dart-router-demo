...
import "package:angular2/src/facade/lang.dart" show normalizeBlank, isPresent;
...
class Directive extends Injectable {
   ...
   * ```
   */
  final Map<String, String> hostActions;
  /**
  ...
  const Directive({selector, properties, events, hostListeners, hostProperties,
      hostAttributes, hostActions, lifecycle, hostInjector,
   ...
   * See {@link onChange}, {@link onDestroy}, {@link onAllChangesDone} for details.
   */
  bool hasLifecycleHook(LifecycleEvent hook) {
    return isPresent(this.lifecycle)
        ? ListWrapper.contains(this.lifecycle, hook)
        : false;
  }
}
/**
...
class Component extends Directive {
   ...
   * ```
   */
  final List<dynamic> appInjector;
  /**
  ...
  const Component({selector, properties, events, hostListeners, hostProperties,
      hostAttributes, hostActions, appInjector, lifecycle, hostInjector,
...
class LifecycleEvent {
  final String name;
  const LifecycleEvent(this.name);
}
/**
 ...
 * @exportedAs angular2/annotations
 */
const onDestroy = const LifecycleEvent("onDestroy");
/**
 ...
 * @exportedAs angular2/annotations
 */
const onChange = const LifecycleEvent("onChange");
/**
 ...
 * @exportedAs angular2/annotations
 */
const onAllChangesDone = const LifecycleEvent("onAllChangesDone");
