...
class Directive extends Injectable {
  ...
  const Directive({selector, properties, events, hostListeners, hostProperties,
      hostAttributes, hostActions, lifecycle, compileChildren: true})
      : selector = selector,
   ...
   * See {@link onChange}, {@link onDestroy}, {@link onAllChangesDone} for details.
   */
  bool hasLifecycleHook(String hook) {
...
class Component extends Directive {
   ...
   * ```
   */
  final List publishAs;
  const Component({selector, properties, events, hostListeners, hostProperties,
      hostAttributes, hostActions, injectables, lifecycle,
      changeDetection: DEFAULT, compileChildren: true, publishAs})
 ...
 * @exportedAs angular2/annotations
 */
const onAllChangesDone = "onAllChangesDone";
